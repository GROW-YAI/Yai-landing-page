...
const AboutProduct = () => {
  ...
  const features = [
    {
      ...
      description: "Crafted from cashew fruit, our pomade is packed with antioxidants and vitamins that revitalize your skin naturally.",
      color: "green",
      icon: (
    ...
    },
    {
      ...
      description: "Rich in Vitamin C, our formula brightens your skin, locks in moisture, and soothes irritation with anti-inflammatory properties.",
      color: "amber",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
    ...
    },
    {
      ...
      description: "We repurpose post-harvest cashew fruit, reducing waste while creating a premium skincare product that's good for you and the planet.",
      color: "purple",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
  ...
  return (
    <section className="relative overflow-hidden py-20 bg-gradient-to-b from-amber-50 to-white" id="about_product">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-700 max-w-2xl mx-auto">
            Discover how cashew fruit transforms into your skin's new best friend
          </p>
        </motion.div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 mb-16">
          ...
          <motion.div 
            ...
            custom={2}
          >
            <h3 className="text-3xl font-semibold text-[#2E2668] mb-6">Cashew Cream</h3>
              ...
              {features.map((feature) => (
                <motion.div
                  ...
                  className={`flex items-start p-4 rounded-xl transition-all duration-300 cursor-pointer ${
                    activeFeature === feature.id ? `bg-${feature.color}-50` : 'hover:bg-gray-50'
                  }`}
                  onClick={() => setActiveFeature(activeFeature === feature.id ? null : feature.id)}
                  whileHover={{ x: 10 }}
                >
                  <div className={`bg-${feature.color}-100 p-2 rounded-full mr-4 mt-1`}>
                    {feature.icon}
                  </div>
                  <div>
            ...
            >
              ...
              <motion.span
                className="absolute inset-0 bg-gradient-to-r from-[#027D00] to-[#2E2668] opacity-0 group-hover:opacity-100 transition-opacity duration-300"
              />
              <motion.svg 
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 backdrop-blur-sm">
          ...
          >
            ...
            <div className="space-y-8">
                ...
                {[
                  {
                    ...
                    description: "Unlock your skin's natural glow with our vitamin-rich formula",
                    color: "amber",
                    icon: "M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707"
                  },
                  {
                    title: "Deep Hydration",
                    description: "Lock in moisture for long-lasting skin hydration",
                    color: "green",
                  ...
                  >
                    <div className={`w-12 h-12 bg-${benefit.color}-100 rounded-full flex items-center justify-center mb-4`}>
                      <svg xmlns="http://www.w3.org/2000/svg" className={`h-6 w-6 text-${benefit.color}-700`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              >
                <h4 className="text-xl font-semibold mb-4">Why Choose Cashew Cream?</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {[
                    ["100% Natural Ingredients", "Rich in Vitamin C", "Anti-inflammatory"],
              ...
              <motion.button 
                ...
                whileTap={{ scale: 0.98 }}
              >
                <span className="relative z-10">Start Your Natural Skincare Journey</span>
                <motion.div
                  className="absolute inset-0 bg-gradient-to-r from-[#027D00] to-[#2E2668] opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                />
              </motion.button>
